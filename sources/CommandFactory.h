...
public:
	 ...
	 * - С вовзратом указателя на экземпляр класса команды происходит и передача владения, а поскольку объект
	 *   создан с помощью оператора new, то и следить за его уничтожением должен вызывающий код
	*/
